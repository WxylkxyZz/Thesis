...
# result.to_excel(result_deposit_path + "word.xlsx", index=False)


word = pd.read_csv(result_deposit_path+"word.csv", encoding='GBK')
# 读入正面、负面情感评价词
pos_comment = pd.read_csv(data_source_path + "《知网》情感分析用词语集（beta版）\正面评价词语（中文）.txt", header=None,sep="\t",encoding='utf-8', engine='python')
neg_comment = pd.read_csv(data_source_path + "《知网》情感分析用词语集（beta版）\负面评价词语（中文）.txt", header=None,sep="\t",encoding='utf-8', engine='python')
pos_emotion = pd.read_csv(data_source_path + "《知网》情感分析用词语集（beta版）\正面情感词语（中文）.txt", header=None,sep="\t",encoding='utf-8', engine='python')
neg_emotion = pd.read_csv(data_source_path + "《知网》情感分析用词语集（beta版）\负面情感词语（中文）.txt", header=None,sep="\t",encoding='utf-8', engine='python')
